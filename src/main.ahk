...
F2::(ActualizarEstado("Ejecutando: Consumir Stamina..."), consumeStamina(), ActualizarEstado("Esperando comando..."))
F3::(ActualizarEstado("Ejecutando: Recolectar Recursos..."), RecolectarRecursos(), ActualizarEstado("Esperando comando..."))
